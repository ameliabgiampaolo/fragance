...
class vam_asociacion_nacional(models.Model):
    ...
    id_pais = models.ForeignKey(vam_pais, on_delete=models.CASCADE)
...
class vam_proveedor(models.Model):
    ...
    id_pais = models.ForeignKey(vam_pais, on_delete=models.CASCADE)
    id_asociacion = models.ForeignKey(vam_asociacion_nacional, on_delete=models.CASCADE)
...
class vam_miembro_ifra(models.Model):
    ...
    tipo = models.CharField(max_length=8) #check = principal, nacional, secundario
    fecha_final = models.DateField()
    id_proveedor = models.ForeignKey(vam_proveedor, on_delete=models.CASCADE)
    id_productor = models.ForeignKey(vam_productor, on_delete=models.CASCADE)
...
class vam_telefono(models.Model):
    ...
    tipo = models.CharField(max_length=8) #check = oficina, personal, fax
    id_proveedor = models.ForeignKey(vam_proveedor, on_delete=models.CASCADE)
    id_productor = models.ForeignKey(vam_productor, on_delete=models.CASCADE)
...
class vam_ingrediente_esencia(models.Model):
    ...
    solubilidad = models.CharField(max_length=50),
...
class vam_ingesen_origen(models.Model):
    ...
    id_ingrediente_esencia = models.ForeignKey(vam_ingrediente_esencia, on_delete=models.CASCADE)
    id_pais = models.ForeignKey(vam_pais, on_delete=models.CASCADE)
...
class vam_ingotro_origen(models.Model):
    ...
    id_ingrediente_otro = models.ForeignKey(vam_ingrediente_otro, on_delete=models.CASCADE)
    id_pais = models.ForeignKey(vam_pais, on_delete=models.CASCADE)
...
class vam_fami_perf(models.Model):
    ...
    id_familia_olfativa = models.ForeignKey(vam_familia_olfativa, on_delete=models.CASCADE)
    id_perfume = models.ForeignKey(vam_perfume, on_delete=models.CASCADE)
...
class vam_fami_palab(models.Model):
    ...
    id_familia_olfativa = models.ForeignKey(vam_familia_olfativa, on_delete=models.CASCADE)
    id_palabra = models.ForeignKey(vam_palabra_clave, on_delete=models.CASCADE)
...
class vam_ingotro_comp(models.Model):
    ...
    id_ingrediente_otro = models.ForeignKey(vam_ingrediente_otro, on_delete=models.CASCADE)
    id_componente = models.ForeignKey(vam_componente, on_delete=models.CASCADE)
...
class vam_presentacion_perfume(models.Model):
    ...
    id_perfume = models.ForeignKey(vam_perfume, on_delete=models.CASCADE)
    id_intensidad = models.ForeignKey(vam_intensidad, on_delete=models.CASCADE)
...
class vam_perf_perfumist(models.Model):
    ...
    id_perfume = models.ForeignKey(vam_perfume, on_delete=models.CASCADE)
    id_perfumista = models.ForeignKey(vam_perfumista, on_delete=models.CASCADE)
...
class vam_evaluacion_criterio(models.Model):
    ...
    id_productor = models.ForeignKey(vam_productor, on_delete=models.CASCADE)
    id_variable = models.ForeignKey(vam_variable, on_delete=models.CASCADE)
...
class vam_elemento_contrato(models.Model):
    ...
    id_contrato = models.ForeignKey(vam_contrato, on_delete=models.CASCADE)
...
class vam_condicion_contrato(models.Model):
    ...
    descripcion = models.CharField(max_length=300)
    id_condicion_pago = models.ForeignKey(vam_condicion_pago, on_delete=models.CASCADE)
    id_condicion_envio = models.ForeignKey(vam_condicion_envio, on_delete=models.CASCADE)
...
class vam_detalle_pedido(models.Model):
    ...
    id_pedido = models.ForeignKey(vam_pedido, on_delete=models.CASCADE)
    id_detalle = models.IntegerField(primary_key=True)
    cantidad = models.IntegerField()
    subtotal = models.DecimalField(max_digits=4, decimal_places=2)
    id_presentacion = models.ForeignKey(vam_presentacion_perfume, on_delete=models.CASCADE)
